...
public class CategoryTest {
    ...
    public void setUp() throws IOException {
        ...
        Ingredient testIngredient1 = new Ingredient("Potato", "Grams", 20);
        Ingredient testIngredient2 = new Ingredient("Fries", "Grams", 200);
        Recipe testRecipe1 = new Recipe("Noodles", "Great noodles for everyone", Arrays.asList(testIngredient1, testIngredient2), testImage, testMiniature);
        Recipe testRecipe2 = new Recipe("French fries", "A classic dinner!", Arrays.asList(testIngredient1, testIngredient2), testImage, testMiniature);
